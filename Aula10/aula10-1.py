...
def transformacao_rotacao():
    ...
    ax.plot(x_trans, y_trans, color='green', linestyle = '-', linewidth=2, marker='s', label=f'Rotacionado {angulo_graus}')
    ...
    raio_a = np.sqrt(x_orig[0]**2 + y_orig[0]**2) # Distância da Origem
